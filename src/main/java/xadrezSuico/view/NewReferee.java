...
public class NewReferee extends JFrame {

	private JPanel contentPane;
	private JTextField textField;
	private JTextField textField_1;
	private JComboBox comboBox;
	private JLabel lblFederation;
	private JComboBox comboBox_1;
	private JLabel lblDataDeNascimento;
	private JTextField textField_2;
	private JLabel lblNewLabel_2;
	private JComboBox comboBox_2;
	private JLabel lblIdFide;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NewReferee frame = new NewReferee();
	 ...
	 */
	public NewReferee() {
		setTitle("Novo Árbitro");
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setBounds(100, 100, 503, 217);
		...
		textField_1.setFont(textField_1.getFont().deriveFont(textField_1.getFont().getStyle() | Font.BOLD));
		...
		lblFederation = new JLabel("Federação");
		...
		gbc_lblFederation.gridy = 2;
		contentPane.add(lblFederation, gbc_lblFederation);
		...
		lblDataDeNascimento = new JLabel("Nascimento");
		...
		lblIdFide = new JLabel("ID FIDE");
		GridBagConstraints gbc_lblIdFide = new GridBagConstraints();
		gbc_lblIdFide.anchor = GridBagConstraints.EAST;
		gbc_lblIdFide.insets = new Insets(0, 0, 5, 5);
		gbc_lblIdFide.gridx = 0;
		gbc_lblIdFide.gridy = 4;
		contentPane.add(lblIdFide, gbc_lblIdFide);
		...
		lblIdLocal = new JLabel("ID Local");
		...
		gbc_lblIdLocal.gridx = 2;
		gbc_lblIdLocal.gridy = 4;
		contentPane.add(lblIdLocal, gbc_lblIdLocal);
